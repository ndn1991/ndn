package com.ndn.common.utils.random;
...
public class XORShiftRandom extends Random {
	private static final long serialVersionUID = -2878009737643905922L;
	...
	private long hashSeed(long seed) {
		byte[] bytes = ByteBuffer.allocate(java.lang.Long.SIZE).putLong(seed)
				.array();
